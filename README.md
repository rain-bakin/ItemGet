...
## how to use
- [First, identify the target area's X and Z coordinate ranges.](docs/check-range.png)
- Set those values in MIN_X, MAX_X, MIN_Z, and MAX_Z in the attached .cs file.
- Create an event inside the target area.
- [Call the C# command from a Parallel Process event sheet.](docs/editor-sample.png)
